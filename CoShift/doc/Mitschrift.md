...
- [x] es zeigt die Schichten in einem Tagesplan an
- [x] die Schichten im Wochenplan sind anklickbar
- [x] es bietet für User die Möglichkeit an sich in eine Schicht einzutragen
- [x] es bietet für Admins die Möglichkeit zur Personenverwaltung
- [x] es bietet für Admins die Möglichkeit zur Schichtenkonfiguration
